...
export class Tab1Page {
  ...
  inputCheck() {
    if (
      ...
      !this.form.tanggal_lahir || !this.form.alamat 
    ) 
    {
  ...
  async sendToWhatsapp() {
    ...
    window.open(`https://api.whatsapp.com/send?phone=6283815906967&text=${output}`, '_blank');
  ...
  async sendToTelegram() {
    ...
    window.open(`https://t.me/Gozzaki?start=${output}`, '_blank');
  }
  ...
  async sendToEmail() {
    ...
    const url = `mailto:gozaliatamimi0@gmail.com?subject=Data&20Informasi&body=${output}`;
